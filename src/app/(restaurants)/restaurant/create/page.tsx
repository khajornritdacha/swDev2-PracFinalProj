...
export default function RestaurantCreatePage() {
  const [restaurant, setRestaurant] = useState({
    ...
    postalcode: '00000',
    tel: '0000000000',
    picture: 'https://instyledecoparis.com/wp-content/uploads/2022/08/Restaurant-Interior-Design-Pizzaria-inside-with-Bar-view-1.jpg',
  });
    ...
    <>
      <div className="h-full w-full flex flex-wrap justify-center">
        <div className="flex flex-col justify-start items-center">
          ...
          <RestaurantForm onSubmit={handleFormSubmit} /> {/* Pass handleFormSubmit as prop */}
        </div >
