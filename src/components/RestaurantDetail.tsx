        ...
        <div className='h-full w-full flex flex-col justify-center items-center gap-4'>
            ...
            <div className="w-[80%] h-auto mx-10 py-1 border-b-2 border-[#999999] mb-4 border-opacity-30 flex items-center justify-center gap-10">
                <div className="h-auto flex items-center justify-center gap-1">
                    ...
                    <p className="text-[16px] font-regular text-[#999999]">{restaurant.foodtype}</p>
                </div>
                ...
                <div className="h-auto flex items-center justify-center gap-1">
                    ...
                    <p className="text-[16px] font-regular text-[#999999]">{restaurant.province}</p>
                </div>
            </div>
            ...
            <div className="w-full flex flex-wrap gap-8 px-[5%] justify-center">
                <div className="w-full max-w-[540px] min-w-[300px] aspect-[534/330] bg-gray-200 rounded-[50px] overflow-hidden shadow-lg">
                    <img src={restaurant.picture} alt="restaurant pic" className="w-full h-full object-cover" />
                </div>

                <div className="w-full max-w-[540px] min-w-[300px] aspect-[534/330]
            ...
            <div className="h-[15%] w-[70%]
                ...
                <div className='h-auto w-full flex justify-center'>
                    <hr style={{ all: 'unset', width: '80%', height: '2px', backgroundColor: '#999999', borderRadius: '8px', opacity: '50%' }} />
                </div>
